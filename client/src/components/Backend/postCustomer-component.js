...
const PostCustomerComponent = ({ currentUser, setCurrentUser }) => {
  let [id, setId] = useState("");
  let [CUS_NAME, setCUS_NAME] = useState("");
  let [PHO_NUM, setPHO_NUM] = useState("");
  let [LEVEL, setLEVEL] = useState(1);
  let [CUS_LIAISON, setCUS_LIAISON] = useState("");
  let [UIN, setUIN] = useState("");
  ...
  const handleChangeCUS_LIAISON = (e) => {
    setCUS_LIAISON(e.target.value);
  };
  const handleChangeUIN = (e) => {
  ...
  const postCus = () => {
    ...
    CustomerService.post(postData)
      .then(() => {
        window.alert("新客戶已創建成功");
        navigate("/CMS/customer");
      })
      .catch((error) => {
        ...
        <div className="form-group">
          <Grid container spacing={2}>
            <Grid item xs={4}>
              ...
              <Item>
                <label htmlFor="exampleforTitle">CUS_NAME</label>
              </Item>
              <Item>
                <label htmlFor="exampleforManufacture">PHO_NUM</label>
              </Item>
              <Item>
                <label htmlFor="exampleforPrice">LEVEL</label>
              </Item>
              <Item>
                <label htmlFor="exampleforCount">CUS_LIAISON</label>
              </Item>
              <Item>
                <label htmlFor="exampleforCount">UIN</label>
              </Item>
              <Item>
            ...
            <Grid item xs={8}>
              ...
              <Item>
                <textarea
                  ...
                  // aria-describedby="emailHelp"
                  name="CUS_LIAISON"
                  onChange={handleChangeCUS_LIAISON}
                  style={{ width: '100%' }}
                  />
              </Item>
              <Item>
...
export default PostCustomerComponent;
